...
// album. If the calling line includes a value for the number of tracks, add that 
// value to the album’s Object.
...
var album = make_album("zuhaib", "light");
console.log(album);
album = make_album("zayan", "red waves");
console.log(album);
album = make_album("waqas", "seenbreeze");
console.log(album);
